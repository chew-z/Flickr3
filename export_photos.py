...
# https://github.com/AaronVanGeffen/ExportPhotosLibrary
...
def getArgs(argv=None):
    ...
    parser = argparse.ArgumentParser(description =
                        'Exports the contents of a Photos.app library to date-based directories.',
                        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('-s', '--source',
                        default="/Volumes/Elements/Pictures/Photos Library.photoslibrary",
                        help='path to Photos.app library')
    parser.add_argument('-d', '--destination',
                        default="/Volumes/Elements/Pictures",
                        help='path to export directory')
    parser.add_argument('-n', '--dryrun', default=False,
                        help="do not copy any files.", action="store_true")
    parser.add_argument('-e', '--exif', default=True, action="store_true",
                        help="set EXIF date information in JPEG files.", )
    parser.add_argument('-f', '--faces', default=True, action="store_true",
                        help="set faces information in EXIF comment for JPEG.")
    parser.add_argument('-l', '--location', default=True, action="store_true",
                        help="append location to directory names.")
    parser.add_argument('-r', '--region', default=False, action="store_true",
                        help="prepend region information to locations.")
    group = parser.add_mutually_exclusive_group()
    group.add_argument('-p', '--progress', default=True, action="store_true",
                        help="show a bar indicating copying progress")
...
def photoTimestamp(row):
    if row["offset"] is not None:
        ...
        return datetime.fromtimestamp(epoch + row["date"], timezone.utc)
